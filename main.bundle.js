...
/***/ (function(module, exports, __webpack_require__) {
	...
	const foodEvents = __webpack_require__(2);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function formTable(meals) {
	  ...
	  $.each(allMeals, function (key, val) {
	    htmlMeals.push(HTMLHelper.newTableDiv(val));
	  });
	...
	function formTableRows(meals) {
	  ...
	  $.each(allMeals, function (key, val) {
	    ...
	    $.each(val.foods, function (keys, value) {
	      htmlMeals[val.name].push(HTMLHelper.newTableEntry(value, "meal-table", val.name.toLowerCase()));
	    });
	  });
